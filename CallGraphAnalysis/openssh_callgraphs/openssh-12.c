...
#line 151 "sshd.c"
struct __anonstruct_sensitive_data_79 {
   Key *server_key ;
   Key *ssh1_host_key ;
   Key **host_keys ;
   int have_ssh1_key ;
...
#line 140
static void g_Ctoc(Char const   *str , char *buf___2 ) ;
#line 141
...
#line 149
static int glob1(Char *pattern , glob_t *pglob , size_t *limitp ) ;
#line 150
static int glob2(Char *pathbuf , Char *pathend , Char *pattern , glob_t *pglob , size_t *limitp ) ;
#line 151
...
#line 163 "openbsd-compat/glob.c"
int glob(char const   *pattern , int flags , int (*errfunc)(char const   * , int  ) ,
         glob_t *pglob ) 
...
#line 215 "openbsd-compat/glob.c"
static int globexp1(Char const   *pattern , glob_t *pglob ) 
{ Char const   *ptr ;
  int rv ;
  int tmp ;
...
#line 239 "openbsd-compat/glob.c"
static int globexp2(Char const   *ptr , Char const   *pattern , glob_t *pglob , int *rv ) 
{ int i ;
  Char *lm ;
  Char *ls ;
...
#line 412 "openbsd-compat/glob.c"
static int glob0(Char const   *pattern , glob_t *pglob ) 
{ Char const   *qpatnext ;
  int c ;
  int err ;
...
#line 502 "openbsd-compat/glob.c"
static int compare(void const   *p , void const   *q ) 
{ size_t __s1_len ;
  size_t __s2_len ;
  int tmp___4 ;
...
#line 520
  tmp = glob2(pathbuf, pathbuf, pattern, pglob, limitp);
#line 520
  return (tmp);
}
}
#line 528 "openbsd-compat/glob.c"
static int glob2(Char *pathbuf , Char *pathend , Char *pattern , glob_t *pglob , size_t *limitp ) 
{ struct stat sb ;
  Char *p ;
  Char *q ;
...
#line 575
      tmp___7 = glob3(pathbuf, pathend, pattern, p, pglob, limitp);
#line 575
      return (tmp___7);
    }
  }
...
#line 605
    if (pglob->gl_errfunc) {
#line 606
      g_Ctoc((Char const   *)pathbuf, buf___2);
#line 607
      tmp___0 = __errno_location();
#line 607
      tmp___1 = (*(pglob->gl_errfunc))((char const   *)(buf___2), *tmp___0);
#line 607
      if (tmp___1) {
#line 609
        return (-2);
...
#line 631
    tmp___4 = match(pathend, pattern, restpattern);
#line 631
    if (! tmp___4) {
#line 632
      *pathend = (unsigned short )'\000';
...
#line 662 "openbsd-compat/glob.c"
static int globextend(Char const   *path , glob_t *pglob , size_t *limitp ) 
{ register char **pathv ;
  register int i ;
  u_int newsize ;
...
#line 698
    g_Ctoc(path, copy);
#line 699
    tmp___4 = pglob->gl_pathc;
#line 699
    (pglob->gl_pathc) ++;
#line 699
    *(pathv + (pglob->gl_offs + tmp___4)) = copy;
  }
#line 701
...
#line 703
    tmp___7 = get_arg_max();
#line 703
    if (newsize + *limitp >= (unsigned int )tmp___7) {
#line 705
...
#line 717 "openbsd-compat/glob.c"
static int match(Char *name , Char *pat , Char *patend ) 
{ int ok ;
  int negate_range ;
  Char c ;
...
#line 765 "openbsd-compat/glob.c"
void globfree(glob_t *pglob ) 
{ register int i ;
  register char **pp ;
  int tmp ;
...
#line 782 "openbsd-compat/glob.c"
static DIR *g_opendir(Char *str , glob_t *pglob ) 
{ char buf___2[4096] ;
  void *tmp ;
  DIR *tmp___0 ;
...
#line 792
    g_Ctoc((Char const   *)str, buf___2);
  }
#line 794
  if (pglob->gl_flags & 64) {
#line 795
    tmp = (*(pglob->gl_opendir))((char const   *)(buf___2));
#line 795
    return ((DIR *)tmp);
  }
#line 797
  tmp___0 = opendir((char const   *)(buf___2));
#line 797
  return (tmp___0);
}
}
#line 800 "openbsd-compat/glob.c"
static int g_lstat(Char *fn , struct stat *sb , glob_t *pglob ) 
{ char buf___2[4096] ;
  int tmp ;
  int tmp___0 ;
  ...
  {
#line 808
  g_Ctoc((Char const   *)fn, buf___2);
#line 809
  if (pglob->gl_flags & 64) {
#line 810
    tmp = (*(pglob->gl_lstat))((char const   *)(buf___2), sb);
#line 810
    return (tmp);
  }
#line 811
  tmp___0 = lstat((char const   * __restrict  )(buf___2), (struct stat * __restrict  )sb);
#line 811
  return (tmp___0);
}
}
#line 814 "openbsd-compat/glob.c"
static int g_stat(Char *fn , struct stat *sb , glob_t *pglob ) 
{ char buf___2[4096] ;
  int tmp ;
  int tmp___0 ;
...
#line 823
  if (pglob->gl_flags & 64) {
#line 824
    tmp = (*(pglob->gl_stat))((char const   *)(buf___2), sb);
#line 824
    return (tmp);
  }
#line 825
  tmp___0 = stat((char const   * __restrict  )(buf___2), (struct stat * __restrict  )sb);
#line 825
  return (tmp___0);
}
}
#line 828 "openbsd-compat/glob.c"
static Char *g_strchr(Char *str , int ch ) 
{ Char *tmp ;
...
#line 858 "openbsd-compat/glob.c"
static void g_Ctoc(Char const   *str , char *buf___2 ) 
{ register char *dc ;
  char *tmp ;
  Char const   *tmp___0 ;
...
#line 1172
      if (_p != _e) {
#line 1172
        log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 1172);
#line 1172
...
#line 1253
    if (_p != _e) {
#line 1253
      log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 1253);
#line 1253
      packet_disconnect("Packet integrity error. (%d)", type);
    }
#line 1253
...
#line 1268
    if (_p != _e) {
#line 1268
      log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 1268);
#line 1268
      packet_disconnect("Packet integrity error. (%d)", type);
    }
#line 1268
...
#line 1306
    if (_p != _e) {
#line 1306
      log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 1306);
#line 1306
      packet_disconnect("Packet integrity error. (%d)", type);
    }
#line 1306
...
#line 1335
      if (_p != _e) {
#line 1335
        log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 1335);
#line 1335
        packet_disconnect("Packet integrity error. (%d)", type);
      }
#line 1335
...
#line 1370
      if (_p != _e) {
#line 1370
        log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 1370);
#line 1370
        packet_disconnect("Packet integrity error. (%d)", type);
      }
#line 1370
...
#line 2249
    if (_p != _e) {
#line 2249
      log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 2249);
#line 2249
...
#line 2477
    if (_p != _e) {
#line 2477
      log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "channels.c", 2477);
#line 2477
      packet_disconnect("Packet integrity error. (%d)", type);
    }
#line 2477
...
#line 66 "compat.c"
static struct __anonstruct_check_68 check[21]  = 
#line 66
...
#line 336
      if (_p != _e) {
#line 336
        log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "ttymodes.c", 336);
#line 336
...
#line 151 "sshd.c"
struct __anonstruct_sensitive_data_79 sensitive_data  ;
#line 164 "sshd.c"
int key_do_regen  =    0;
#line 167 "sshd.c"
...
#line 710
  debug("sshd version %.100s", "OpenSSH_2.5.2p2");
#line 713
...
#line 1322
    if (_p != _e) {
#line 1322
      log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "sshd.c", 1322);
#line 1322
...
#line 1529
  dh = dh_new_group1();
#line 1530
  dh_gen_key(dh, kex___0->we_need * 8);
#line 1532
...
#line 221 "servconf.c"
static struct __anonstruct_keywords_80 keywords[45]  = 
#line 221
  {      {"port", 1}, 
        {"hostkey", 2}, 
        {"hostdsakey", 2}, 
...
#line 321
      fatal("bad addr or host: %s (%s)", tmp___1, tmp___0);
    }
#line 324
    ai = aitop;
#line 324
...
#line 415
    if (*intptr >= 256) {
#line 416
      fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"%s line %d: too many host keys specified (max %d).\n",
...
#line 444
    if (! arg) {
#line 445
      fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"%s line %d: missing yes/without-password/forced-commands-only/no argument.\n",
              filename, linenum);
#line 448
      exit(1);
    } else {
...
#line 606
      fatal("%.200s line %d: unsupported log level \'%s\'", filename, linenum, tmp___65);
    }
#line 608
    if (*intptr == -1) {
#line 609
...
#line 257
      if (_p != _e) {
#line 257
        log("Packet integrity error (%d != %d) at %s:%d", _p, _e, "session.c", 257);
#line 257
        packet_disconnect("Packet integrity error. (%d)", type);
      }
#line 257
...
{ Channel *c ;
  ...
  union __anonunion_71___0 __constr_expr_1 ;
  union __anonunion_72___0 __constr_expr_2 ;
  union __anonunion_73___0 __constr_expr_3 ;
  union __anonunion_74___0 __constr_expr_4 ;
